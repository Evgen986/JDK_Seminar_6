...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Среднее арифметическое значение элементов массива = " + descriptiveStatistics.getMean());
        System.out.println("=====================================");
        System.out.println("Факториал числа 5 = " + ArithmeticUtils.factorial(5));
        System.out.println("Наименьшее общее частное чисел 15, 25 = " + ArithmeticUtils.lcm(15,25));
